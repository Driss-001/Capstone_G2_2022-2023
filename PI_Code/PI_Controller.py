...
class PI_Controller:
    ...
    def _corr_min(self,n)->float:
        ...
        level = 0.085-max(self.adc_output[0:round(0.3*dip_perc*n)])
...
if __name__ == '__main__':
    ...
    test1 = PI_Controller(test =1,test_duration =1,V_supply=5,n_iter = 15,sampling_f=100,autorun=1,conc=100,c_noise=True, Training=False,detection = False) #50 points frequency teut